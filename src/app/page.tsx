						...
						<div className="flex flex-col justify-center space-y-4">
							<div className="space-y-2">
								<h1 className="text-3xl font-bold tracking-tighter text-foreground sm:text-5xl xl:text-6xl/none">
									Hello, I'm Chad Jipiti
								</h1>
								<p className="max-w-[600px] text-muted-foreground md:text-xl">
									A leading AI researcher specializing in language models and pushing the boundaries of natural language processing.
								</p>
							</div>
				...
				<div className="container px-4 md:px-6">
					<div className="flex flex-col items-center justify-center space-y-4 text-center">
						<div className="space-y-2">
							...
							<p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
								I specialize in these AI technologies and research areas
							</p>
						</div>
					</div>
					<div className="mt-12">
						<div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
							{["PyTorch", "TensorFlow", "JAX", "Transformers", "Python", "NLP", "BERT", "GPT", "Neural Networks", "CUDA", "Distributed Training", "Reinforcement Learning"].map((skill) => (
				...
				<div className="container px-4 md:px-6">
					<div className="flex flex-col items-center justify-center space-y-4 text-center">
						<div className="space-y-2">
							...
							<p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
								Interested in AI research collaboration or have questions about language models? Let's connect.
							</p>
						</div>
						<div className="flex flex-col gap-2 min-[400px]:flex-row">
							<Link
